...
\begin{document}
	...
	\begin{frame}
		...
		\begin{mytheorem}{\en SUDOKU}{\el Ορισμός}
...
\begin{frame}
	\frametitle{\el Δημιουργία \en SUDOKU \el παζλ από προγενέστερα παζλ}
	\begin{itemize}
		\item \el  ́Ενας ακόμη τρόπος για να δημιουργησουμε νέα παζλ \en SUDOKU \el είναι να αλλάξουμε, με
		συγκεκριμένη τεχνική, τους ακεραίους του \en SUDOKU \el που ήδη διαθέτουμε.
	\end{itemize}
\end{frame}
